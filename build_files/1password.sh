...
# 1password
# "it's just a bunch of shell scripts is the joke nix users don't get"
# yeah, but this is a more funny joke
# https://github.com/blue-build/modules/blob/main/modules/bling/installers/1password.sh#L49-L55
